    ...
    return (
        <div className="CourseItems_Syllabus_Subtitles_1">
            ...
            <div className={!showDetails?"CourseItems_Syllabus_Subtitles_Content":"CourseItems_Syllabus_Subtitles_Content_Details"}onClick={!showDetails?handleShowDetails:""} >
                ...
                <a href="/"><h3 style={{color:"#000"}}>Tutorial {i+1}</h3></a>
                <a href="/"><h3 style={{color:"rgb(0, 140, 255)"}} className="CourseItems_OpenItem">Open Video</h3></a>
                </div>
                )}
                ...
                <a href="/"><h3 style={{color:"#000",transform:"translate(-.6rem , 0rem)"}} >Exercise</h3></a>
                <a href="/"><h3 style={{color:"rgb(0, 140, 255)"}} className="CourseItems_OpenItem2"> Exercise {props.exercise}</h3></a>
                </div>
